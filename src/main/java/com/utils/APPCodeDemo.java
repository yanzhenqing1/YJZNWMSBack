...
public class APPCodeDemo {
    private static APPCodeDemo appCodeDemo = new APPCodeDemo();
    /*
     * 获取参数的json对象
     */
    ...
    public static APPCodeDemo getAPPCodeDemo(){
        return appCodeDemo;
    }
    ...
    public String uploadImage(String filePath){
        ...
        String appcode = "13e1fbeab5c2411288f8d385019e3d93";
//        本地路径
        ...
        try {
            ...
            if(is_old_format) {
                ...
                obj_img = out.toJSONString();
//                System.out.println(out.toJSONString()+"-------130");
            }else{
//                System.out.println(res_obj.toJSONString()+"---------------132");
                obj_img = res_obj.toJSONString();
